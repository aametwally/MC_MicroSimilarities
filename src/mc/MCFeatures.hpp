...
public:
    ...
    meanHistograms(
            const std::map<std::string, HeteroHistogramsFeatures> &trainedHistograms,
    ...
    populationRadius(
            const std::map<std::string, std::vector<HeteroHistograms >> &traininedHistograms,
    ...
    static HeteroHistogramsFeatures
    informationRadius_UNIFORM(
            HistogramForwardIt histogramsFirstIt,
            HistogramForwardIt histogramsLastIt,
            const Selection &selection,
            Retriever &&retrieve
    )
    {
    ...
    static HeteroHistogramsFeatures
    informationRadius_UNIFORM(
            const std::vector<HeteroHistograms> &profiles,
            const Selection &selection
    )
    {
        return informationRadius_UNIFORM( profiles.cbegin(), profiles.cend(),
    ...
    static HeteroHistogramsFeatures
    informationRadius_UNIFORM(
            std::vector<std::reference_wrapper<const HeteroHistograms>> &&profiles,
            const Selection &selection
    )
    {
